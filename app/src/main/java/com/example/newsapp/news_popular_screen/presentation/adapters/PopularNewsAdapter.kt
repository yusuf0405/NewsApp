...
class PopularNewsAdapter @Inject constructor(
    private val actionListener: PopularItemOnClickListener,
) : PagingDataAdapter<Article, PopularNewsAdapter.NewsViewHolder>(MovieDiffItemCallback) {
